...
Antes de continuar, certifique-se de que o bug que você encontrou ainda não foi relatado na sessão <a href="https://github.com/juletopi/Pagina_Cyberpunk-Edgerunners/issues">Issues</a> deste repositório.

- Se um bug NÃO estiver mencionado nas <a href="https://github.com/juletopi/Pagina_Cyberpunk-Edgerunners/issues">Issues</a>, abra uma nova. Certifique-se de incluir um título, uma descrição clara do comportamento esperado que não está ocorrendo.
> [!TIP]\
...
1. **Fork e Clone**
   - Faça um fork do [repositório](https://github.com/juletopi/Pagina_Cyberpunk-Edgerunners)
   - Clone seu fork: `git clone https://github.com/SEU-USUARIO/Pagina_Cyberpunk-Edgerunners.git`
...
- Faça qualquer pergunta sobre o repositório abrindo uma nova<br>discussão na sessão de [Discussions](https://github.com/juletopi/Pagina_Cyberpunk-Edgerunners/discussions) deste repositório.
